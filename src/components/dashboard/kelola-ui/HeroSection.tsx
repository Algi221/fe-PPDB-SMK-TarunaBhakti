...
import { Upload, Building, FileText, Info, Calendar } from "lucide-react";
...
export interface HeroProps {
  ...
  gelombangConfig: any;
  setGelombangConfig: React.Dispatch<React.SetStateAction<any>>;
  g1Error: string | null;
...
export default function HeroSection(props: HeroProps) {
  const {
    schoolLogo, handleSchoolLogoChange, dragActiveStates, handleDragState,
    schoolTitle, setSchoolTitle, heroTitle, setHeroTitle, heroTitleSub, setHeroTitleSub, heroSubtitle, setHeroSubtitle,
    phone, setPhone, email, setEmail, schoolPeriod, setSchoolPeriod, address, setAddress, waGroupUrl, setWaGroupUrl, waAdmin, setWaAdmin,
    gelombangConfig, setGelombangConfig, g1Error, setG1Error, g2Error, setG2Error
  } = props;
