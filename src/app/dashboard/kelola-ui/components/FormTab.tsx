...
import { FieldConfigItem, DEFAULT_FIELDS_CONFIG_UI, formatRupiah } from "../types";
      ...
      <div className="border-t border-slate-100 dark:border-white/5 pt-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-3 py-1.5 text-[9px] font-black uppercase tracking-wider border border-slate-200 dark:border-white/5 rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-900 transition-all cursor-pointer"
          >
            Reset Default
          </button>
        </div>
                  ...
                  <td className="px-4 py-2.5 text-center">
                    <button
                      ...
                      className={`w-9 h-5 rounded-full relative transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed ${
                        cfg.required && cfg.active ? 'bg-emerald-500 cursor-pointer' : 'bg-slate-200 dark:bg-slate-700'
                      }`}
