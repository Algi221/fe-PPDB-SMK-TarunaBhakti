...
export const DEFAULT_MAJORS: MajorItem[] = [
  ...
  },
  {
    ...
    facilities: [
      ...
      "Cinematography & Audio Equipment Suite"
    ],
    logo: "/assets/jurusan/dkv.png",
    banner: "https://images.unsplash.com/photo-1626785774573-4b799315345d?q=80&w=1200&auto=format&fit=crop",
    video: "",
    gallery: [
      { url: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=600&auto=format&fit=crop", caption: "Sesi Photoshoot Produk & Commercial Photography" },
      { url: "https://images.unsplash.com/photo-1581291518655-9523c93269c3?q=80&w=600&auto=format&fit=crop", caption: "Digital Art & Painting di Meja Wacom" },
      { url: "https://images.unsplash.com/photo-1572044162444-ad60f128bdea?q=80&w=600&auto=format&fit=crop", caption: "Diskusi Desain Brand Guideline" },
      { url: "https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=600&auto=format&fit=crop", caption: "Eksplorasi Tipografi dan Komposisi Warna" }
    ]
  },
  {
    code: "BC",
    title: "Broadcasting & Perfilman",
    desc: "Kuasai teknik produksi film, penyiaran televisi langsung (live broadcast), penulisan naskah, tata cahaya profesional, dan podcasting modern.",
    color: "#f59e0b",
    careers: [
      { title: "TV Program Director", desc: "Memimpin jalannya proses shooting dan broadcast televisi dari control room." },
      { title: "Director of Photography (DoP)", desc: "Menentukan sudut kamera, tone warna visual sinematik, dan pencahayaan film." },
      { title: "Professional Video Editor", desc: "Menyusun potongan klip video, color grading, dan visual effects produksi video." },
      { title: "Podcast & Sound Producer", desc: "Merekam, mixing, dan mastering audio siaran podcast agar jernih dan berbobot." }
    ],
    facilities: [
      "Broadcast TV Studio (Multi-Camera System)",
      "Soundproof Audio Dubbing & Podcast Suite",
      "Blackmagic Design 4K Cinema Production Hub",
      "Color Grading Suite (DaVinci Resolve Certified)",
      "Live Streaming Control & Production Switcher Room"
    ],
    logo: "/assets/jurusan/broadcasting.png",
    banner: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?q=80&w=1200&auto=format&fit=crop",
    video: "",
    gallery: [
      { url: "https://images.unsplash.com/photo-1518173946687-a4c8a383392e?q=80&w=600&auto=format&fit=crop", caption: "Pengambilan Gambar Sinematik Luar Ruang" },
      { url: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?q=80&w=600&auto=format&fit=crop", caption: "Sesi Rekaman Podcast Profesional di Studio" },
      { url: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?q=80&w=600&auto=format&fit=crop", caption: "Proses Color Grading Video di Ruang Pascaproduksi" },
      { url: "https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=600&auto=format&fit=crop", caption: "Operasional Multi-Kamera di Master Control Room (MCR)" }
    ]
  },
  {
    code: "ANIMASI",
    title: "Animasi 2D & 3D",
    desc: "Ciptakan karya magis lewat animasi 2D, 3D modeling, rigging karakter ekspresif, texturing realistis, visual effect (VFX), dan game asset.",
    color: "#ec4899",
    careers: [
      { title: "3D Character Animator", desc: "Menghidupkan karakter 3D agar bergerak luwes, dinamis, dan memiliki emosi nyata." },
      { title: "3D Modeler & Texturing Artist", desc: "Membangun model objek, lingkungan, dan tekstur material untuk kebutuhan film." },
      { title: "Rigging Technical Director", desc: "Merancang struktur tulang dan pengendali sendi digital untuk karakter 3D." },
