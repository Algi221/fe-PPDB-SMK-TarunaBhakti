...
export default function DaftarPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center py-16 px-4 md:px-6 overflow-hidden">
      ...
      {/* Floating Navbar style for "Kembali" */}
      <div className="navbar-wrapper">
        <nav className="navbar scrolled" style={{justifyContent: 'space-between'}}>
          <div className="flex items-center gap-3">
            ...
            <div className="logo-container hidden sm:flex">
              <img src="/logo_smktb.png" alt="Logo SMK TB" className="w-6 h-6 object-contain" />
              <span className="logo-text font-extrabold text-xs">PPDB <span>SMK TB</span></span>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <span className="hidden sm:inline text-xs font-semibold text-slate-400">Tahap {wizardStep}/13</span>
            <button 
              onClick={toggleDark} 
              className="flex items-center justify-center w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors border border-slate-200 dark:border-slate-700" 
      ...
      <div className="mb-10 text-center mt-12 relative z-10">
        <h1 className="text-3xl md:text-4xl font-extrabold text-slate-800 mb-2 drop-shadow-sm">Formulir Pendaftaran PPDB</h1>
        <p className="text-slate-500 font-medium bg-white/60 backdrop-blur-md inline-block px-4 py-1.5 rounded-full border border-white/60 shadow-sm mt-2">SMK Taruna Bhakti Tahun Ajaran 2026/2027</p>
      </div>

      <div className="bg-white/80 backdrop-blur-xl border border-white/60 shadow-[0_20px_50px_rgba(0,102,255,0.06)] rounded-[2.5rem] p-6 md:p-10 max-w-4xl w-full relative z-10">
            ...
            return (
              <div
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm z-10 transition-all duration-300 cursor-pointer select-none ${isCurrent
                  ...
                  : isCompleted
                    ? "bg-blue-600 text-white hover:bg-blue-700 hover:scale-105 ring-2 ring-blue-300 ring-offset-2"
                    : "bg-white text-slate-400 border-2 border-slate-200 hover:border-blue-400 hover:text-blue-500 hover:scale-105"
                  }`}
              >
