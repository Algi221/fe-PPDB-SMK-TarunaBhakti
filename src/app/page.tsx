          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-10 max-w-5xl mx-auto">
            {(() => {
              const remotePartners = [
                { name: "Dinas Pendidikan Propinsi Jabar", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Lambang_Pemerintah_Provinsi_Jawa_Barat.svg/800px-Lambang_Pemerintah_Provinsi_Jawa_Barat.svg.png", url: "http://disdik.jabarprov.go.id/", h: "h-20" },
                ...
                { name: "Cisco Networking Academy", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Cisco_logo_blue_2016.svg/1024px-Cisco_logo_blue_2016.svg.png", url: "https://www.netacad.com/", h: "h-12" },
                { name: "AWS Academy", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Amazon_Web_Services_Logo.svg/1024px-Amazon_Web_Services_Logo.svg.png", url: "https://aws.amazon.com/training/awsacademy/", h: "h-12" },
                { name: "Red Hat Academy", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Red_Hat_logo.svg/1024px-Red_Hat_logo.svg.png", url: "https://www.redhat.com/en/services/training/red-hat-academy", h: "h-10" },
                { name: "Oracle Academy", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Oracle_logo.svg/1024px-Oracle_logo.svg.png", url: "https://academy.oracle.com/en/oa-web-overview.html", h: "h-10" },
              ];
